        ...
        for (k = 0; k < nSTAGE; k++)
        {
         for (l = 0; l < 3; l++)
         {
           for (m = 0; m < 3; m++)
           {
            ...
            //printf("%3d %3d\n",pixels[i * 5 + j + k * 25 + l * 5 + m],weights[9 * k + l * 3 + m]);
           }
         }
         //printf("\n");
        }
...
Make the address sanitizer a debug feature'or at least make it so that any one that doesn't call the Hook function doesn't simply get the error
