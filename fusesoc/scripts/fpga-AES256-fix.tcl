...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1_0/submodules/VERSAT/hardware/src/StridedMerge.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1_0/submodules/VERSAT/hardware/src/SwapEndian.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1_0/submodules/VERSAT/hardware/src/TestConst.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1_0/submodules/VERSAT/hardware/src/TimedMux.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/AES256Path.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/AES256WithIterative.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/AESPathExample.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/AES.v}
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/AESWithIterative.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/Comb_M_Stage.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/Iterative_SHA_F.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/MainRoundAndKey.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/RoundPairAndKey.v}
...
read_verilog -sv {../src/iobundle_opencryptohw_0.0.1-versat_gen_aes256_0/software/pc-emul/src/VectorLikeOperation.v}
...
set_property verilog_define {RUN_EXTMEM=1 USE_DDR=1 INIT_MEM=0 DATA_W=32 ADDR_W=32 BOOTROM_ADDR_W=12 SRAM_ADDR_W=12 FIRM_ADDR_W=18 DCACHE_ADDR_W=24 N_SLAVES=4 E=31 P=30 B=29 UART=0 TIMER=1 VERSAT=2 ETHERNET=3 N_SLAVES_W=2 HARDWARE_TEST=1 USE_MUL_DIV=1 USE_COMPRESSED=1 DDR_DATA_W=32 DDR_ADDR_W=30 AXI_ADDR_W=32 } [get_filesets sources_1]
